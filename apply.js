document.addEventListener('DOMContentLoaded', () => {
    ...
    if (grantForm) {
        ...
        grantForm.addEventListener('submit', (e) => {
            ...
            // NOTE: For file uploads, we'll just store the filename for this simulation.
            // A real backend would handle the file upload stream.
            ...
            const isDuplicate = applications.some(app => 
                app.email === applicationData.email || 
                app.nin === applicationData.nin || 
                app.bvn === applicationData.bvn
            );
            ...
            // If not a duplicate, add a unique ID and timestamp
    ...
    if (loginForm) {
        ...
        loginForm.addEventListener('submit', (e) => {
            ...
            // In a real application, this check MUST be done on a server.
        ...
        function loadApplications() {
            ...
            if (applications.length === 0) {
                tbody.innerHTML = '<tr><td colspan="15" style="text-align:center;">No applications found.</td></tr>';
                return;
            }
